            ...
            <div class="col-sm-3">
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="row">
                            <div class="col-sm-12">
                                <img class="blog_detail_left_col_img" src="../../../../resources/images/smooth.jfif" alt="">
                            </div>
                    ...
                    <div class="col-sm-12">
                       <div class="row">
                           <div class="col-sm-12 text-center blog_detail_main_board_contents">
                               <p class="blog_detail_board_title">서면 무한리필 착한돼지 짱짱추천!
                               짱짱 맛있어요!</p>
                               
                               <img src="../../../../resources/images/detail_gogi1.jpg" alt="">
                               <p class="blog_detail_board_title">서면 무한리필 착한돼지 짱짱추천!
                               짱짱 맛있어요!</p>
