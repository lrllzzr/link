                ...
                <div class="row blog-row-1">
                    ...
                    <a href="">
                        <div class="col-sm-4 blog-row-2 text-center">
                            <img src="/link/resources/images/flower1.jpg" alt="">
                            <div class="row text-center">
                                <div class="col-sm-6 blog-hottopic-info">
                                    꽃 관련으로 진로 생각 중이에요
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="">
                        <div class="col-sm-4 blog-row-2 text-center">
                            <img src="/link/resources/images/flower2.png" alt="">
                            <div class="row text-center">
                                <div class="col-sm-6 blog-hottopic-info">
                                    꽃꽃이는 배울수록 더 재밌어요
                                </div>
                    ...
                    <a href="">
                        ...
                        <div class="col-sm-4 blog-row-2 text-center">
                            <img src="/link/resources/images/flower3.jpg" alt="">
                            <div class="row text-center">
                                <div class="col-sm-6 blog-hottopic-info">
                                    꽃을 너무 좋아해요!!
                                </div>
            ...
            <div class="col-sm-3 blog-col-3">
                <div class="row">
                    ...
                    <div class="col-sm-7 blog-right-col-1">
                        <div class="row">
                            <div class="col-sm-6">
                                <span><a href="">ahnbmin</a></span>
                            </div>
                            <div class="col-sm-6 text-right">
                                <span class="blog-rigbt-col-logout"><a href="">로그아웃</a></span>
                            </div>
                ...
                <div class="row blog-col-6 text-center">
                    <div class="col-sm-12">
                        <div class="row blog-alarm">
                            <div class="col-sm-10">
                                <img class="blog-row-3-profile-img" src="/link/resources/images/jisik.jpg" alt="">
                                <a href="">호야님이 서로이웃을 신청했습니다.</a>
                            </div>
                            <div class="col-sm-1">
