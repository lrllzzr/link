...
/* String path = "C:/Users/BM/git/repository7/link/src/main/webapp/resources/images/userblogimgs"; // 이미지가 저장될 주소 */
String path = "C:/Users/BMAHN/git/link/link/src/main/webapp/resources/images/userblogimgs"; // 이미지가 저장될 주소
String filename = "";
